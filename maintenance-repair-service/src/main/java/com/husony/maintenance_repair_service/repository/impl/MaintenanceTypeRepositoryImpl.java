...
public class MaintenanceTypeRepositoryImpl implements MaintenanceTypeRepository {
    ...
    public List<MaintenanceType> getMaintenanceType(Map<String, String> params) {
        ...
        Root<MaintenanceType> root = q.from(MaintenanceType.class);
        q.select(root);
    ...
    public void addOrUpdate(MaintenanceType l) {
        if (l.getId() != null && entityManager.find(MaintenanceType.class, l.getId()) != null) {
    ...
    public MaintenanceType getMaintenanceTypeById(Long id) {
        return entityManager.find(MaintenanceType.class, id);
    }

    @Override
    public void deleteMaintenanceType(Long id) {
        entityManager.remove(this.getMaintenanceTypeById(id));
    }
}
